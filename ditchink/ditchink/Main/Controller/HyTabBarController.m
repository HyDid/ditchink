...
- (void)setupChildViewControllers
{
    ...
    [self setupChildViewController:Message title:@"消息" imageName:@"" selectedImageName:@""];
    HyHomeViewController *home = [[HyHomeViewController alloc] init];
    [self setupChildViewController:home title:@"首页" imageName:@"" selectedImageName:@""];
    HyMeViewController *Me = [[HyMeViewController alloc] init];
    [self setupChildViewController:Me title:@"我的" imageName:@"" selectedImageName:@""];
